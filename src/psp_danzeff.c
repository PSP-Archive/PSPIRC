...
static int modeChar[MAX_VKEYBOARD][3][3][5] = 
{
	...
	{	//numbers
		{ { DANZEFF_LIST,   0 , DANZEFF_KICK      , '1', '\0' }, 
      { DANZEFF_JOIN,   0 , DANZEFF_BAN       , '2', '\0' }, 
      { DANZEFF_PART,   0 , DANZEFF_MODE      , '3', '\0' }},
                   
		{ { DANZEFF_NICK ,  0 , DANZEFF_ENTER     , '4', '\0' }, 
      { DANZEFF_DEL  ,  0 ,                ' ', '5', '\0' }, 
      { DANZEFF_CLEAR,  0 , DANZEFF_WHO       , '6', '\0' }},

		{ { DANZEFF_WHOIS,  0 , DANZEFF_OPER      , '7', '\0' }, 
      { DANZEFF_INVITE, 0 , DANZEFF_COLOR     , '8', '\0' }, 
      { '.'           , 0 ,                '0', '9', '\0' }},
	},
...
{
  char skin_path[128];
  strcpy(skin_path, PSPIRC.psp_homedir);
...
danzeff_load()
{
  ...
  if (psp_kbd_skin_first) {
	...
	{
    strcpy(tmp_filename, PSPIRC.psp_homedir);
